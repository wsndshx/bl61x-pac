...
pub type R = crate::R<RTC_CONTROL_0_SPEC>;
#[doc = "Register `rtc_control_0` writer"]
pub type W = crate::W<RTC_CONTROL_0_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<RTC_CONTROL_0_SPEC> {
...
#[doc = "Real-Time Clock control and reset register 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rtc_control_0::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rtc_control_0::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
