...
pub type R = crate::R<RADIO_CONFIG_SPEC>;
#[doc = "Register `radio_config` writer"]
pub type W = crate::W<RADIO_CONFIG_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<RADIO_CONFIG_SPEC> {
