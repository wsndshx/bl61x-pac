...
pub type R = crate::R<GPIO_OUTPUT_SPEC>;
#[doc = "Register `gpio_output[%s]` writer"]
pub type W = crate::W<GPIO_OUTPUT_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<GPIO_OUTPUT_SPEC> {
...
#[doc = "Write value to Generic Purpose Input/Output pins\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio_output::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio_output::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
