...
pub type R = crate::R<CORE_CFG19_SPEC>;
#[doc = "Register `core_cfg19` writer"]
pub type W = crate::W<CORE_CFG19_SPEC>;
#[doc = "Field `np_int_mask1` reader - "]
pub type NP_INT_MASK1_R = crate::FieldReader<u32>;
#[doc = "Field `np_int_mask1` writer - "]
pub type NP_INT_MASK1_W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn np_int_mask1(&mut self) -> NP_INT_MASK1_W<CORE_CFG19_SPEC> {
        NP_INT_MASK1_W::new(self, 0)
    }
...
#[doc = "core_cfg19.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`core_cfg19::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`core_cfg19::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
