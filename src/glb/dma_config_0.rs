...
pub type R = crate::R<DMA_CONFIG_0_SPEC>;
#[doc = "Register `dma_config_0` writer"]
pub type W = crate::W<DMA_CONFIG_0_SPEC>;
#[doc = "Field `dma_clk_en` reader - "]
pub type DMA_CLK_EN_R = crate::FieldReader;
#[doc = "Field `dma_clk_en` writer - "]
pub type DMA_CLK_EN_W<'a, REG> = crate::FieldWriter<'a, REG, 8>;
impl R {
    #[doc = "Bits 24:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_clk_en(&mut self) -> DMA_CLK_EN_W<DMA_CONFIG_0_SPEC> {
        DMA_CLK_EN_W::new(self, 24)
    }
