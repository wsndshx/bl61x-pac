...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swrst_s00(&mut self) -> SWRST_S00_W<RESET_STS0_SPEC> {
        SWRST_S00_W::new(self, 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s01(&mut self) -> SWRST_S01_W<RESET_STS0_SPEC> {
        SWRST_S01_W::new(self, 1)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s20(&mut self) -> SWRST_S20_W<RESET_STS0_SPEC> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swrst_s30(&mut self) -> SWRST_S30_W<RESET_STS0_SPEC> {
        SWRST_S30_W::new(self, 8)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s31(&mut self) -> SWRST_S31_W<RESET_STS0_SPEC> {
        SWRST_S31_W::new(self, 9)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s32(&mut self) -> SWRST_S32_W<RESET_STS0_SPEC> {
        SWRST_S32_W::new(self, 10)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s33(&mut self) -> SWRST_S33_W<RESET_STS0_SPEC> {
        SWRST_S33_W::new(self, 11)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_emi_misc(&mut self) -> SWRST_S1_EXT_EMI_MISC_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_EMI_MISC_W::new(self, 16)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_psram0_ctrl(&mut self) -> SWRST_S1_EXT_PSRAM0_CTRL_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_PSRAM0_CTRL_W::new(self, 17)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_psram1_ctrl(&mut self) -> SWRST_S1_EXT_PSRAM1_CTRL_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_PSRAM1_CTRL_W::new(self, 18)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_usb(&mut self) -> SWRST_S1_EXT_USB_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_USB_W::new(self, 19)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_mix2(&mut self) -> SWRST_S1_EXT_MIX2_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_MIX2_W::new(self, 20)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_audio(&mut self) -> SWRST_S1_EXT_AUDIO_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_AUDIO_W::new(self, 21)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_sdh(&mut self) -> SWRST_S1_EXT_SDH_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_SDH_W::new(self, 22)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_emac(&mut self) -> SWRST_S1_EXT_EMAC_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_EMAC_W::new(self, 23)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_dma2(&mut self) -> SWRST_S1_EXT_DMA2_W<RESET_STS0_SPEC> {
        SWRST_S1_EXT_DMA2_W::new(self, 24)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_d2x_a(&mut self) -> SWRST_D2X_A_W<RESET_STS0_SPEC> {
        SWRST_D2X_A_W::new(self, 25)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_d2x_b(&mut self) -> SWRST_D2X_B_W<RESET_STS0_SPEC> {
        SWRST_D2X_B_W::new(self, 26)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_jenc(&mut self) -> SWRST_JENC_W<RESET_STS0_SPEC> {
        SWRST_JENC_W::new(self, 27)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn swrst_s1_ext_pio(&mut self) -> SWRST_S1_EXT_PIO_W<RESET_STS0_SPEC> {
