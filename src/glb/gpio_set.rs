...
pub type R = crate::R<GPIO_SET_SPEC>;
#[doc = "Register `gpio_set[%s]` writer"]
pub type W = crate::W<GPIO_SET_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<GPIO_SET_SPEC> {
...
#[doc = "Set pin output value to high\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`gpio_set::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`gpio_set::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
