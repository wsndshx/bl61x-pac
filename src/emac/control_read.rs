...
pub type R = crate::R<CONTROL_READ_SPEC>;
#[doc = "Register `control_read` writer"]
pub type W = crate::W<CONTROL_READ_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<CONTROL_READ_SPEC> {
