...
pub type R = crate::R<FIFO_CONTROL_SPEC>;
#[doc = "Register `fifo_control` writer"]
pub type W = crate::W<FIFO_CONTROL_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<FIFO_CONTROL_SPEC> {
...
#[doc = "Controls audio input FIFO\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`fifo_control::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`fifo_control::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
