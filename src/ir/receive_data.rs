...
pub type R = crate::R<RECEIVE_DATA_SPEC>;
#[doc = "Register `receive_data[%s]` writer"]
pub type W = crate::W<RECEIVE_DATA_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<RECEIVE_DATA_SPEC> {
...
#[doc = "??\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`receive_data::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`receive_data::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
